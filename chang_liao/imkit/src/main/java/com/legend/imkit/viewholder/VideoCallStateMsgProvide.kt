...
class VideoCallStateMsgProvide: BaseMessageItemProvider<CallStateContent, ItemCallStateMsgBinding>() {
...
//            flContent.setPadding(0,0,0,0)
        ...
        contentBinding?.apply {
            ...
            ImgLoader.display(context, R.drawable.ic_msg_video_call, imgIcon)
            ...
            if (item.message.isSender) {
                ...
                ImgLoader.display(context, R.drawable.ic_msg_video_call_white, imgIcon)
    ...
    override val itemViewType: Int = TypeConst.chat_msg_type_video_call_state
}