package com.legend.imkit.popwindow.action;
...
public class PopMenuAdapter extends BaseAdapter {
    ...
    public void setDataSource(final List datas) {
        dataSource = datas;
        ExecutorHelper.getInstance().mainThread().execute(() -> notifyDataSetChanged());
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(Applications.getCurrent().getApplicationContext()).inflate(R.layout.pop_menu_adapter, parent, false);
