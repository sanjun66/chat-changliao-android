...
interface ConversationFragmentCallback {
    ...
    fun addCallStatusTipsListener(callStatusTipListener: CallActivity.CallStatueTipsListener)

    fun removeCallStatusTipsListener(callStatueTipsListener: CallActivity.CallStatueTipsListener)
    ...
    fun onSwitchAudio(enableSpeaker: Boolean)
