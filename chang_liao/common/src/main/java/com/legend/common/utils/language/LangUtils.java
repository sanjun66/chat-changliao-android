package com.legend.common.utils.language;
...
//    }
     ...
     * @return
     */
    public static RCLocale getAppLanguageLocal(Context context) {
        RCLocale appLocale = getAppLocale(context);
        if (appLocale == RCLocale.LOCALE_AUTO) {
