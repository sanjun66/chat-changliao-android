...
import com.legend.common.bean.FileInfo;
...
public class FileTypeUtils {
    ...
    public static final String AUTH_FILE_PROVIDER = ".FileProvider";
...
//            return 0;
//        }
//        String suffix = fileName.toLowerCase().substring(fileName.lastIndexOf(".") + 1, fileName.length());
...
//    }
    ...
    public static Intent getOpenFileIntent(Context context, String fileName, String fileSavePath) {
        ...
        if (type != null && fileSavePath != null && isIntentHandlerAvailable(context, intent)) {
            Uri uri = FileProvider.getUriForFile(
                            context, context.getApplicationContext().getPackageName() + AUTH_FILE_PROVIDER,
    ...
    public static String getIntentType(Context context, Intent intent, String fileName) {
        String type = null;
        if (checkSuffix(
                fileName, context.getResources().getStringArray(R.array.rc_image_file_suffix))) {
    ...
    public static FileInfo getFileInfoFromFile(final File file) {
