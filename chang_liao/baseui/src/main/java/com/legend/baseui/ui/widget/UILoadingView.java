...
public class UILoadingView extends View {
    ...
    public UILoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.UILoadingView_ui_loading_view_size, DensityUtil.dip2px(context, 32));
    ...
    private void drawLoading(Canvas canvas, int rotateDegrees) {
        int width = mSize / 12, height = mSize / 6, halfSize = mSize / 2, halfWidth = width / 2;
        ...
        for (int i = 0; i < LINE_COUNT; i++) {
            ...
            canvas.translate(0, -halfSize + halfWidth);
