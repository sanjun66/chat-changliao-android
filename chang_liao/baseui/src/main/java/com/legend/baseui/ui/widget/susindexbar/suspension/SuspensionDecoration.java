package com.legend.baseui.ui.widget.susindexbar.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#E8E8E8");
    ...
    public SuspensionDecoration setTitleMarginLeft(int titleMarginLeft) {
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), titleMarginLeft, child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        c.drawText(tag, titleMarginLeft,
