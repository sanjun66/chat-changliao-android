...
import static com.legend.baseui.ui.widget.toggle.Util.createLayoutParams;
import static com.legend.baseui.ui.widget.toggle.Util.createMatchParams;
import static com.legend.baseui.ui.widget.toggle.Util.createMatchWrapParams;
...
public class SpringConfiguratorView extends FrameLayout {
  ...
  public SpringConfiguratorView(Context context, AttributeSet attrs, int defStyle) {
    ...
    mRevealPx = DensityUtil.dip2px(getContext(), 40);
    mStashPx =  DensityUtil.dip2px(getContext(), 280);
  ...
  private View generateHierarchy(Context context) {
    ...
    LayoutParams params;
    int fivePx =  DensityUtil.dip2px(getContext(), 6);
    int tenPx =  DensityUtil.dip2px(getContext(), 10);
    int twentyPx = DensityUtil.dip2px(getContext(), 20);
    ...
    params = createLayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, DensityUtil.dip2px(getContext(), 300));
    root.setLayoutParams(params);
      ...
      root.addView(container);
        ...
        params = createMatchWrapParams();
        params.setMargins(0, 0, 0, DensityUtil.dip2px(getContext(), 80));
        ...
        container.addView(linearLayout);
          ...
          linearLayout.addView(seekWrapper);
            ...
            params = createLayoutParams(DensityUtil.dip2px(getContext(), 50), ViewGroup.LayoutParams.MATCH_PARENT);
      ...
      params = createLayoutParams(DensityUtil.dip2px(getContext(), 60), DensityUtil.dip2px(getContext(), 40));
  ...
  private class SpinnerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (convertView == null) {
        ...
        int twelvePx = DensityUtil.dip2px(getContext(), 12);
