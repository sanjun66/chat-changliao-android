...
public class BottomBarLayout extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init() {
        ...
        for (int i = 0; i < childCount; i++) {
            if (getChildAt(i) instanceof BottomBarItem) {
                ...
                //设置点击监听
                bottomBarItem.setOnClickListener(new BottomNavClickListener(i));
            } else {
    ...
    private class BottomNavClickListener implements OnClickListener {

        private int currentIndex;

        public BottomNavClickListener(int i) {
            this.currentIndex = i;
        }
