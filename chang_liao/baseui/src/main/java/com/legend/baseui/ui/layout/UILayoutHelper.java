package com.legend.baseui.ui.layout;
...
public class UILayoutHelper implements IUILayout {
    ...
    // default value
    private int generalShadowElevation;
    ...
    public UILayoutHelper(Context context, AttributeSet attrs, int defAttr, int defStyleRes, View owner) {
        ...
        mBottomDividerColor = mTopDividerColor =
                ContextCompat.getColor(context, R.color.ui_layout_color_separator);
        mMode = new PorterDuffXfermode(PorterDuff.Mode.DST_OUT);
        mClipPaint = new Paint();
        mClipPaint.setAntiAlias(true);
        mShadowAlpha = 0.25f;
        mBorderRect = new RectF();
        generalShadowElevation = DensityUtil.dip2px(context, 15);
    ...
    public void setUseThemeGeneralShadowElevation() {
        mShadowElevation = generalShadowElevation;
