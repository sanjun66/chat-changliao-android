package com.legend.baseui.ui.widget.toggle;
...
public class ToggleButton extends View {
	...
	/** 开启颜色*/
	private int onColor = Color.parseColor("#44db5e");
	/** 关闭颜色*/
	private int offBorderColor = Color.parseColor("#dadbda");
	/** 灰色带颜色*/
	private int offColor = Color.parseColor("#dadada");
	/** 手柄颜色*/
	...
	private void setup(AttributeSet attrs) {
		...
		TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ui_ToggleButton);
		offBorderColor = typedArray.getColor(R.styleable.ui_ToggleButton_offBorderColor, offBorderColor);
		onColor = typedArray.getColor(R.styleable.ui_ToggleButton_onColor, onColor);
		spotColor = typedArray.getColor(R.styleable.ui_ToggleButton_spotColor, spotColor);
		offColor = typedArray.getColor(R.styleable.ui_ToggleButton_offColor, offColor);
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.ui_ToggleButton_borderWidth1, borderWidth);
		defaultAnimate = typedArray.getBoolean(R.styleable.ui_ToggleButton_animate, defaultAnimate);
		isDefaultOn = typedArray.getBoolean(R.styleable.ui_ToggleButton_isDefaultOn, isDefaultOn);
		typedArray.recycle();
	...
	public void setOnColor(@ColorInt int color) {
		onColor = color;
	}
	...
	//按钮是否可用
	public void setToggleEnable(boolean paramBoolean) {
		if (paramBoolean) {
