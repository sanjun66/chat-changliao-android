package com.legend.baseui.ui.widget.flow;
...
//    <declare-styleable name="FlowLayout1">
//            <attr name="lineSpacing_1" format="dimension" />
//            <attr name="maxLine_1" format="integer" />
//            </declare-styleable>
...
public class FlowLayout extends ViewGroup {
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs,
                R.styleable.ui_FlowLayout1);
        lineSpacing = mTypedArray.getDimensionPixelSize(
                R.styleable.ui_FlowLayout1_ui_lineSpacing_1, 0);
        mTypedArray.recycle();
    }
