package com.legend.baseui.ui.widget.edittext;
...
public class SplitEditTextView extends AppCompatEditText {
    ...
    private void initAttrs(Context c, AttributeSet attrs) {
        TypedArray array = c.obtainStyledAttributes(attrs, R.styleable.UISplitEditTextView);
        mBorderSize = array.getDimension(R.styleable.UISplitEditTextView_ui_borderWidth, dp2px(1f));
        mBorderColor = array.getColor(R.styleable.UISplitEditTextView_ui_borderColor, Color.BLACK);
        mCornerSize = array.getDimension(R.styleable.UISplitEditTextView_ui_corner_size, 0f);
        mDivisionLineSize = array.getDimension(R.styleable.UISplitEditTextView_ui_divisionLineSize, dp2px(1f));
        mDivisionColor = array.getColor(R.styleable.UISplitEditTextView_ui_divisionLineColor, Color.BLACK);
        mCircleRadius = array.getDimension(R.styleable.UISplitEditTextView_ui_circleRadius, dp2px(5f));
        mContentNumber = array.getInt(R.styleable.UISplitEditTextView_ui_contentNumber, 6);
        mContentShowMode = array.getInteger(R.styleable.UISplitEditTextView_ui_contentShowMode, CONTENT_SHOW_MODE_PASSWORD);
        mInputBoxStyle = array.getInteger(R.styleable.UISplitEditTextView_ui_inputBoxStyle, INPUT_BOX_STYLE_CONNECT);
        mSpaceSize = array.getDimension(R.styleable.UISplitEditTextView_ui_spaceSize, dp2px(10f));
        mTextSize = array.getDimension(R.styleable.UISplitEditTextView_android_textSize, sp2px(16f));
        mTextColor = array.getColor(R.styleable.UISplitEditTextView_android_textColor, Color.BLACK);
        mInputBoxSquare = array.getBoolean(R.styleable.UISplitEditTextView_ui_inputBoxSquare, true);
        mCursorColor = array.getColor(R.styleable.UISplitEditTextView_ui_cursorColor, Color.BLACK);
        mCursorDuration = array.getInt(R.styleable.UISplitEditTextView_ui_cursorDuration, 500);
        mCursorWidth = array.getDimension(R.styleable.UISplitEditTextView_ui_cursorWidth, dp2px(2f));
        mCursorHeight = (int) array.getDimension(R.styleable.UISplitEditTextView_ui_cursorHeight, 0);
        mUnderlineNormalColor = array.getInt(R.styleable.UISplitEditTextView_ui_underlineNormalColor, Color.BLACK);
        mUnderlineFocusColor = array.getInt(R.styleable.UISplitEditTextView_ui_underlineFocusColor, 0);
        array.recycle();
        init();
    }
