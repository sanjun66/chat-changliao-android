...
public class FadingEdgeRecyclerView extends MaxHeightRecyclerView {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray arr = getContext().obtainStyledAttributes(attrs, R.styleable.ui_FadingEdgeRecyclerView, defStyleAttr, 0);
            int flags = arr.getInt(R.styleable.ui_FadingEdgeRecyclerView_ui_fadingEdge, 0);
            ...
            gradientSize = arr.getDimensionPixelSize(R.styleable.ui_FadingEdgeRecyclerView_ui_fadingEdgeLength, 0);

            gradientSizeTop = arr.getDimensionPixelSize(R.styleable.ui_FadingEdgeRecyclerView_ui_fadingEdgeTopLength, defaultSize);
            gradientSizeBottom = arr.getDimensionPixelSize(R.styleable.ui_FadingEdgeRecyclerView_ui_fadingEdgeBottomLength, defaultSize);
            gradientSizeLeft = arr.getDimensionPixelSize(R.styleable.ui_FadingEdgeRecyclerView_ui_fadingEdgeLeftLength, defaultSize);
            gradientSizeRight = arr.getDimensionPixelSize(R.styleable.ui_FadingEdgeRecyclerView_ui_fadingEdgeRightLength, defaultSize);
