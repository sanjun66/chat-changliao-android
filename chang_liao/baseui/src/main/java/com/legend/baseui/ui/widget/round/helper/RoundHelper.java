...
package com.legend.baseui.ui.widget.round.helper;
...
public class RoundHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ui_RoundAttrs);
        mRoundAsCircle = ta.getBoolean(R.styleable.ui_RoundAttrs_ui_round_as_circle, false);
        mStrokeColorStateList = ta.getColorStateList(R.styleable.ui_RoundAttrs_ui_stroke_color);
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.ui_RoundAttrs_ui_stroke_width, 0);
        mClipBackground = ta.getBoolean(R.styleable.ui_RoundAttrs_ui_clip_background, false);
        int roundCorner = ta.getDimensionPixelSize(R.styleable.ui_RoundAttrs_ui_round_corner, 0);
        int roundCornerTopLeft = ta.getDimensionPixelSize(
                R.styleable.ui_RoundAttrs_ui_round_corner_top_left, roundCorner);
        int roundCornerTopRight = ta.getDimensionPixelSize(
                R.styleable.ui_RoundAttrs_ui_round_corner_top_right, roundCorner);
        int roundCornerBottomLeft = ta.getDimensionPixelSize(
                R.styleable.ui_RoundAttrs_ui_round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight = ta.getDimensionPixelSize(
                R.styleable.ui_RoundAttrs_ui_round_corner_bottom_right, roundCorner);
        ta.recycle();
