package com.legend.baseui.ui.widget.bottombar;
...
public class BottomBarItem extends LinearLayout {
    ...
    private int unreadTextSize = 8; //未读数默认字体大小10sp
    ...
    public BottomBarItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.HtBottomBarItem);
    ...
    private void initAttrs(TypedArray ta) {
        normalIcon = ta.getDrawable(R.styleable.HtBottomBarItem_iconNormal);
        selectedIcon = ta.getDrawable(R.styleable.HtBottomBarItem_iconSelected);

        title = ta.getString(R.styleable.HtBottomBarItem_itemText);
        titleTextBold = ta.getBoolean(R.styleable.HtBottomBarItem_itemTextBold, titleTextBold);
        titleTextSize = ta.getDimensionPixelSize(R.styleable.HtBottomBarItem_itemTextSize, DisplayUtils.sp2px(context, titleTextSize));

        titleNormalColor = ta.getColor(R.styleable.HtBottomBarItem_textColorNormal, context.getResources().getColor(R.color.ui_black_001038));
        titleSelectedColor = ta.getColor(R.styleable.HtBottomBarItem_textColorSelected, context.getResources().getColor(R.color.ui_primary));

        marginTop = ta.getDimensionPixelSize(R.styleable.HtBottomBarItem_itemMarginTop, DisplayUtils.dp2px(context, marginTop));

        openTouchBg = ta.getBoolean(R.styleable.HtBottomBarItem_openTouchBg, openTouchBg);
        touchDrawable = ta.getDrawable(R.styleable.HtBottomBarItem_touchDrawable);

        iconWidth = ta.getDimensionPixelSize(R.styleable.HtBottomBarItem_iconWidth, 0);
        iconHeight = ta.getDimensionPixelSize(R.styleable.HtBottomBarItem_iconHeight, 0);
        itemPadding = ta.getDimensionPixelSize(R.styleable.HtBottomBarItem_itemPadding, 0);

        unreadTextSize = ta.getDimensionPixelSize(R.styleable.HtBottomBarItem_unreadTextSize, DisplayUtils.sp2px(context, unreadTextSize));
        unreadTextColor = ta.getColor(R.styleable.HtBottomBarItem_unreadTextColor, context.getResources().getColor(R.color.ui_white));
        unreadTextBg = ta.getDrawable(R.styleable.HtBottomBarItem_unreadTextBg);

        msgTextSize = ta.getDimensionPixelSize(R.styleable.HtBottomBarItem_msgTextSize, DisplayUtils.sp2px(context, msgTextSize));
        msgTextColor = ta.getColor(R.styleable.HtBottomBarItem_msgTextColor, context.getResources().getColor(R.color.ui_white));
        msgTextBg = ta.getDrawable(R.styleable.HtBottomBarItem_msgTextBg);

        notifyPointBg = ta.getDrawable(R.styleable.HtBottomBarItem_notifyPointBg);

        unreadNumThreshold = ta.getInteger(R.styleable.HtBottomBarItem_unreadThreshold, unreadNumThreshold);

        lottieJson = ta.getString(R.styleable.HtBottomBarItem_lottieJson);
    ...
    private void checkValues() {
        ...
        if (unreadTextBg == null) {
            unreadTextBg = getResources().getDrawable(R.drawable.ui_shape_unread);
        }

        if (msgTextBg == null) {
            msgTextBg = getResources().getDrawable(R.drawable.ui_shape_msg);
        }

        if (notifyPointBg == null) {
            notifyPointBg = getResources().getDrawable(R.drawable.ui_shape_notify_point);
        }
    }
    ...
    private View initView() {
        View view = View.inflate(context, R.layout.ui_item_bottom_bar, null);
        if (itemPadding != 0) {
            //如果有设置item的padding
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            this.context = context;
            titleTextBold = false;
            titleTextSize = DisplayUtils.sp2px(context, 12);
            titleNormalColor = getColor(R.color.ui_color_999999);
            titleSelectedColor = getColor(R.color.ui_primary);
            unreadTextSize = DisplayUtils.sp2px(context, 10);
            msgTextSize = DisplayUtils.sp2px(context, 6);
            unreadTextColor = getColor(R.color.ui_white);
            unreadNumThreshold = 99;
            msgTextColor = getColor(R.color.ui_white);
        }
        ...
        public Builder titleTextSize(int titleTextSize) {
            this.titleTextSize = DisplayUtils.sp2px(context, titleTextSize);
            return this;
        }
        ...
        public Builder unreadTextSize(int unreadTextSize) {
            this.unreadTextSize = DisplayUtils.sp2px(context, unreadTextSize);
            return this;
        }
        ...
        public Builder msgTextSize(int msgTextSize) {
            this.msgTextSize = DisplayUtils.sp2px(context, msgTextSize);
            return this;
        }
        ...
        public BottomBarItem create(int normalIconId, int selectedIconId, String text) {
            return create(context.getResources().getDrawable(normalIconId), context.getResources().getDrawable(selectedIconId), text);
        }
