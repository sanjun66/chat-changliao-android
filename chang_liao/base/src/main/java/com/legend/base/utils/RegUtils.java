...
import com.legend.base.utils.constants.RegexConstants;
...
public class RegUtils {
    public static final String REG_VERIFICATION_CODE = "^[0-9]{6}$"; //验证验证码的正则
    ...
    public static boolean isBankCard(String cardNo) {
        Pattern pattern = Pattern.compile(RegexConstants.ACCOUNT_NUMBER_PATTERN);
    ...
    public static boolean isVer(String ver) {
        Pattern pattern = Pattern.compile(RegexConstants.REG_VERC);
    ...
    public static boolean isImgVer(String ver) {
        Pattern pattern = Pattern.compile(RegexConstants.REG_IMG_VERC);
        Matcher matcher = pattern.matcher(ver);
        return matcher.matches();
    }
    ...
    public static boolean isIdCard(String card) {
        Pattern pattern = Pattern.compile(RegexConstants.REGEX_ID_CARD);
